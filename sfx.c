...
const unsigned short dischargeNotes[3] = {SND_RATE(NOTE_G, 0), SND_RATE(NOTE_E, 0), SND_RATE(NOTE_D, 0)};
const unsigned short dischargeTimes[3] = {5, 5, 5};
const sound_effect discharge = {dischargeNotes, dischargeTimes, 3};
...
const unsigned short winNotes[7] = {SND_RATE(NOTE_D, 1), SND_RATE(NOTE_E, 1), SND_RATE(NOTE_FIS, 1), SND_RATE(NOTE_A, 1), SND_RATE(NOTE_GIS, 1), SND_RATE(NOTE_A, 1), SND_RATE(NOTE_B, 1)};
const unsigned short winTimes[7] = {30, 30, 30, 10, 10, 10, 60};
const sound_effect win = {winNotes, winTimes, 7};

const unsigned short loseNotes[7] = {SND_RATE(NOTE_D, 1), SND_RATE(NOTE_B, 0), SND_RATE(NOTE_A, 0), SND_RATE(NOTE_B, 0), SND_RATE(NOTE_A, 0), SND_RATE(NOTE_G, 0), SND_RATE(NOTE_FIS, 0)};
const unsigned short loseTimes[7] = {30, 30, 30, 10, 10, 10, 60};
const sound_effect lose = {loseNotes, loseTimes, 7};